...
<body>
    <section class="home-section">
        <main class="contenedor container px-5">
            ...
            <a href="<?php echo App; ?>/admin<?php echo App; ?>/index.php" class="boton boton-verde">Volver</a>

            <h2>Crear Juego</h2>

            <form method="POST" action="<?php echo App; ?>/admin/crear.php" enctype="multipart/form-data">
                <table width="540">
                    <tr valign="top">
